...
//
//               return WS.url(feedUrl).setHeader("Accept", "text/xml").get().map(
//                        response -> {
//                            String responseBody = response.getBody();
//                            String responseBodyPreview = responseBody.substring(0,100);
//                            System.out.println("the beginning of the response is : " + responseBodyPreview.substring(0, 100));
